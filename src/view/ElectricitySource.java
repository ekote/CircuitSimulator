 ...
 */
public class ElectricitySource extends CircuitComponent {
    public ElectricitySource(int x, int y) {
        super(x, y, 140, 180);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (getOrientation() == Orientation.Horizontal) {
            ...
            g.drawLine(x, y, x + d-hr, y);
            g.drawLine(x+2*d+hr, y, x + 3*d, y);
            ...
            g.drawArc(x + 5 * hr, y - 4 * hr, 8 * hr, 8 * hr, 0, 360);
        ...
        else
        {
            ...
            g.drawArc(x - 4 * hr, y + d - hr, 8*  hr, 8 * hr, 0, 360);

            g.drawLine(x, y, x, y+d - hr);

            g.drawLine(x, y+d+5, x, y+d+25 );
            g.drawLine(x, y+2*d+hr, x, y+3*d);
